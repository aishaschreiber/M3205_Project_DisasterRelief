...
complete_data = []
with open("/Users/aishaschreiber/Documents/GitHub/M3205_Project_DisasterRelief/CLFDIP Model Data Generation Tool/Instances (Sets and Parameters)/Pr05_S4.txt", 'r') as textfile:
...
# # Read in the data from csv and take each component and put it into a dictionary        
# complete_data = []
# with open("/Users/aishaschreiber/Documents/GitHub/M3205_Project_DisasterRelief/Pr01_S10.txt", 'r') as textfile:
#     for line in textfile:
#         complete_data.append(line.strip())  # Remove leading/trailing whitespace
