...
def MultipleDemand(avail_TFs):
    ...
    return Md_s, TFd_sm, TFu_sm, Reverse_Id 
...
for kk in range(20):
    ...
    for s in S:
        ...
        # Make the set
            ...
            Md_s, TFd_sm, TFu_sm, Reverse_Id = MultipleDemand(avail_TFs)
         ...
         # Define reduced here
            ...
            Constraint25 = {i:
                        ...
                        <= Kd_si[s][i]) 
                        for i in Reverse_Id[s]} # WE ADDED for m in Md_s[s], but its causing an error
